...
nohup sh -c "python3 -m adv_transformer.train --cs_model_dir=output_distilbert_adv2 --cs_gpu=1 --cs_tfm_type=distilbert-base-uncased --cs_adv_train=True --cs_train_steps=15 --cs_k_fold=1 --cs_tfm_ft_enc_layers=1"&>nohup_distilbert_adv2.out&
