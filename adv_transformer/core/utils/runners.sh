...
nohup sh -c "python3 -m adv_transformer.train --cs_model_dir=output_distilbert_adv --cs_gpu=1 --cs_tfm_type=distilbert-base-uncased --cs_train_steps=10 --cs_adv_train=True --cs_perturb_id=6"&>nohup_distilbert_adv.out&
