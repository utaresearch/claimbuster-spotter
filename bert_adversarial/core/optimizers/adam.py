...
class AdamWeightFriction(optimizer_v2.OptimizerV2):
    ...
    def __init__(self,
        ...
        super(AdamWeightFriction, self).__init__(name, **kwargs)
    ...
    def _prepare_local(self, var_device, var_dtype, apply_state):
        super(AdamWeightFriction, self)._prepare_local(var_device, var_dtype, apply_state)
    ...
    def set_weights(self, weights):
        ...
        super(AdamWeightFriction, self).set_weights(weights)
    ...
    def get_config(self):
        config = super(AdamWeightFriction, self).get_config()
        config.update({
