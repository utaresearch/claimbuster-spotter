...
class Embedding:
    ...
    def create_embedding_matrix(self, sess):
        ...
        save_path = saver.save(sess, os.path.join(FLAGS.cb_output_dir, "embedding_matrix_tf.ckpt"))
        tf.logging.info("Model saved in path: " + save_path)

        return embedding_matrix

    def retrieve_embedding_matrix(self, sess):
        target_file = os.path.join(FLAGS.cb_output_dir, "embedding_matrix_tf.ckpt")
