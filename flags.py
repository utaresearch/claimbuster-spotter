...
flags.DEFINE_bool('tfm_ft_embed', True, 'Train BERT embedding layer')
flags.DEFINE_bool('tfm_ft_pooler', True, 'Train BERT pooler layer')
flags.DEFINE_integer('tfm_ft_enc_layers', 12, 'Last `var` encoding layers are marked as trainable')
...
flags.DEFINE_integer('batch_size_reg', 24, 'Size of the batch.')
...
if any(['large' in FLAGS.bert_model_size]):
	...
	FLAGS.batch_size_reg //= 3
	FLAGS.batch_size_adv //= 3
