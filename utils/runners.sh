...
nohup sh -c "python3 pretrain.py --cb_model_dir=reg_clef --gpu=0 --use_clef_data=True --weight_classes_loss=True -num_classes=2 --restore_and_continue=False"&>nohup.out&
nohup sh -c "python3 advtrain.py --cb_model_dir=adv_clef --gpu=1 --use_clef_data=True --weight_classes_loss=True -num_classes=2 --restore_and_continue=False"&>nohup1.out&
nohup sh -c "python3 pretrain.py --cb_model_dir=reg_ours_clef --gpu=2 --use_clef_data=True --combine_ours_clef_data=True --weight_classes_loss=True -num_classes=2 --restore_and_continue=False"&>nohup2.out&
nohup sh -c "python3 advtrain.py --cb_model_dir=adv_ours_clef --gpu=3 --use_clef_data=True --combine_ours_clef_data=True --weight_classes_loss=True -num_classes=2 --restore_and_continue=False"&>nohup3.out&
