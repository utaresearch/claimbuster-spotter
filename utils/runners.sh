...
python3 pretrain.py --cb_model_dir=reg_ours_clef --gpu=2 --use_clef_data=True --combine_ours_clef_data=True --weight_classes_loss=True -num_classes=2 --restore_and_continue=False