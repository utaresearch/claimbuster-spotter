...
flags.DEFINE_string('cs_data_file', 'kfold_20ncs.json', 'Data file to use')
...
# Optimization
flags.DEFINE_integer('cs_train_steps', 5, 'Number of epochs to run.')
...
flags.DEFINE_string('cs_raw_kfold_data_loc', '{0}/two_class/{1}'.format(FLAGS.cs_data_dir, FLAGS.cs_data_file), 'Location of raw data for k-fold cross validation')
